 ...
 * @author 平台脚本生成
 */
public class N_SA01_UNAPPROVE extends AbstractCompiler2 {
private java.util.Hashtable m_methodReturnHas=new java.util.Hashtable();
private Hashtable m_keyHas=null;
/**
 * N_SA01_UNAPPROVE 构造子注解。
 */
public N_SA01_UNAPPROVE() {
	super();
}
/*
* 备注：平台编写规则类
...
try{
	super.m_tmpVo=vo;
	//####本脚本必须含有返回值,返回DLG和PNL的组件不允许有返回值####         procUnApproveFlow (vo); 
